...
void setup() {
  ...
  xTaskCreatePinnedToCore(modeIdentify, "modeIdentify", 1024 * 10, NULL, 1, NULL, 1);
  xTaskCreatePinnedToCore(motorControl, "motorControl", 1024 * 16, NULL, 2, NULL, 1);
  xTaskCreatePinnedToCore(NTC_task, "temperatureRead", 1024 * 10, NULL, 1, NULL, 1);
  ...
  xTaskCreatePinnedToCore(Fan_task, "Fan_Task", 1024 * 10, NULL, 1, NULL, 1);
  xTaskCreatePinnedToCore(fault_task, "fault_task", 1024 * 10, NULL, 3, &faultTaskHandle, 1);
}
